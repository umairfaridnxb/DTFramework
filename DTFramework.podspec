...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "http://github.com/Rageeni/demoTouchFramework.git"
  ...
  # Or just: spec.author    = "Umair Farid"
  # spec.authors            = { "Umair Farid" => "umair.farid@nxb.com.pk" }
  # spec.social_media_url   = "https://twitter.com/Umair Farid"
  ...
  spec.source       = { :git => "http://s3-ap-southeast-1.amazonaws.com/uxarmymedia/demoTouchFramework.zip" }
